    ...
    >
      <nav className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <a href="#hero" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 rounded-lg bg-[oklch(0.78_0.18_195/0.1)] border border-[oklch(0.78_0.18_195/0.35)] flex items-center justify-center group-hover:border-[oklch(0.78_0.18_195/0.7)] group-hover:shadow-[0_0_16px_oklch(0.78_0.18_195/0.3)] transition-all duration-300 flex-shrink-0">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
            ...
            >
              ...
              <line
                ...
                strokeLinecap="round"
              />
              <circle cx="8" cy="8" r="1" fill="oklch(0.84 0.16 196)" />
            </svg>
          </div>
          <span className="font-black font-display text-base tracking-tight neon-text-cyan hidden sm:block">
            TimeMaster
          </span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-6">
          {links.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="text-sm font-medium font-body text-muted-foreground hover:text-foreground transition-colors duration-200 hover:neon-text-cyan"
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="flex items-center gap-3">
          <a
            href="#tools"
            className="hidden md:block neon-btn-cyan rounded-lg px-4 py-2 text-sm font-semibold font-display"
          >
            Free Tools →
          </a>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 50% 60% at 50% 50%, oklch(0.78 0.18 195 / 0.07) 0%, transparent 65%)",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent, transparent 2px, oklch(0.78 0.18 195 / 0.015) 2px, oklch(0.78 0.18 195 / 0.015) 4px)",
        }}
      />
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-screen py-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              <span className="text-foreground/90">Time is not</span>
              <br />
              <span className="text-foreground/90">money. It is</span>
              <br />
              <span
            ...
            >
              <a
                href="#concepts"
                className="neon-btn-cyan rounded-xl px-7 py-3.5 font-bold font-display text-base"
              >
                Start Learning →
              </a>
              <a
                href="#tools"
                className="neon-btn-violet rounded-xl px-7 py-3.5 font-bold font-display text-base"
              >
                Free Tools
              </a>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex flex-wrap gap-10 mt-14 pt-8 border-t border-[oklch(0.78_0.18_195/0.1)]"
            >
              {[
                { label: "Time Principles", value: "5+" },
                { label: "Free Tools", value: "3" },
                { label: "Hours Saved Daily", value: "∞" },
              ].map((stat, i) => (
          ...
          <div className="order-1 lg:order-2 flex items-center justify-center">
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 50% 50%, oklch(0.78 0.18 195 / 0.12) 0%, oklch(0.65 0.22 280 / 0.06) 50%, transparent 70%)",
                }}
              />
              <Suspense
                fallback={
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="w-16 h-16 border-2 border-[oklch(0.78_0.18_195)] border-t-transparent rounded-full animate-spin" />
                  </div>
                }
              >
                <HeroClock />
      ...
      >
        ...
        <motion.div
          ...
          className="w-px h-8 bg-gradient-to-b from-[oklch(0.78_0.18_195)] to-transparent"
        />
      </motion.div>
    </section>
  );
  ...
  return (
    <section id="tools" className="relative py-24 px-4 section-glow-divider">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 30% 60%, oklch(0.65 0.22 280 / 0.05) 0%, transparent 60%)",
        }}
      />
      ...
      <div ref={ref} className="max-w-7xl mx-auto">
        ...
        >
          <p className="section-label mb-4">Productivity Arsenal</p>
          <h2 className="text-4xl md:text-5xl font-black font-display text-foreground mb-4">
            Free <span className="neon-text-violet">Tools</span> for{" "}
            <span className="neon-text-cyan">Every Day</span>
          </h2>
...
function Footer() {
  ...
  return (
    <footer className="relative border-t border-[oklch(0.25_0.04_255/0.3)] py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          {/* Logo */}
          <div className="flex items-center gap-2">
            <span className="text-lg">⏱</span>
            <span className="font-black font-display neon-text-cyan">
              TimeMaster
            </span>
        ...
        <div className="border-t border-[oklch(0.25_0.04_255/0.2)] mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-muted-foreground font-body">
