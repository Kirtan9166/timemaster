...
export class Backend implements backendInterface {
    ...
    async addGoal(arg0: string, arg1: string): Promise<void> {
    ...
    async getGoalsCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getGoalsCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveDailyStats(arg0: string, arg1: Array<TimeBlock>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDailyStats(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
